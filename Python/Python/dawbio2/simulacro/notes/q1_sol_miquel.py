...
def fix_broken_tycho(entries: pd.DataFrame) -> pd.DataFrame:
    ...
    fixed_entries.loc[:,'disease'] = fixed_entries.loc[:,'disease'].str.replace(pat=new_disease_format, repl='', regex=True)
    ...
    ## Fixing step 5 and 7 Add a new column called 'id' with a numerical unique identifier starting from 0
...
if __name__ == "__main__":
    ...
    print(fixed_entries.head(20).to_string(index=False))
